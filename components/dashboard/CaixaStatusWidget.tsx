...
export default function CaixaStatusWidget({
  ...
  }, [fetchStatus, organizationId, profile]);
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div
              className={`p-2 rounded-full ${isAtivo ? 'bg-emerald-100 text-emerald-600' : 'bg-slate-100 text-slate-400'}`}
            >
