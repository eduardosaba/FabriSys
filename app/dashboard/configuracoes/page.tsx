...
export default function ConfiguracoesPage() {
  ...
  const canAccessCustomizacao = !isExpress && (roleStr === 'admin' || roleStr === 'master' || roleStr === 'gerente');
  ...
  return (
    <div className="container space-y-4 md:space-y-6 py-4 md:py-6 animate-fade-up max-h-[calc(100vh-6rem)] overflow-auto px-3 md:px-0">
      <PageHeader
        title="Configurações"
        description="Gerencie as regras de negócio, acessos e a identidade visual do sistema."
        icon={Settings}
      />
      ...
      <div className="mt-6">
        ...
        {activeTab === 'customizacao' && canAccessCustomizacao && <CustomizacaoTab />}
      </div>
    </div>
  );
}
