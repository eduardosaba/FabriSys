...
const users = [
  ...
  { id: '3bedd5be-0992-4a07-a794-e84b36d7c7c4', email: 'eduardosaba.rep@gmail.com', password: 'fabrica123' },
...
async function run() {
  for (const u of users) {
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/auth/v1/admin/users/${u.id}`, {
        method: 'PATCH',
        headers: {
