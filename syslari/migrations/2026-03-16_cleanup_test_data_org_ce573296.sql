...
-- Organização alvo: ce573296-9b54-4bc9-882e-f88152b670e8
...
-- DELETE FROM ordens_producao WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8';

-- Remover pedidos de distribuição (expedição)
-- DELETE FROM distribuicao_pedidos WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8';

-- Remover movimentos de estoque gerados por testes
-- DELETE FROM movimentacao_estoque WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8';

-- Remover vendas/pedidos (caso existam nessa instalação)
-- DELETE FROM vendas WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8';
-- DELETE FROM pedidos WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8';

-- Remover alertas gerados por testes
-- DELETE FROM alertas_fabrica WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8';
...
-- DELETE FROM estoque_produtos WHERE organization_id = 'ce573296-9b54-4bc9-882e-f88152b670e8' AND (metadata->>'test' = 'true' OR created_at < '2026-03-01');
...
-- pg_dump "postgresql://<DB_USER>:<DB_PASS>@<DB_HOST>:<DB_PORT>/<DB_NAME>" -Fc -f backup_org_ce573296.dump
